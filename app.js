/* 447A Exam Simulator, Application Logic */

const ACCESS_CODE  = "447A9000";
const EXAM_SECONDS = 14400;
const PASSING_PCT  = 70;
const STORAGE_KEY  = "447a_exam_state_v1";
const SIM_Q_COUNT  = 0;  // simulator serves this project's configured pool size (config.json exam.sim_questions)
const CLUSTER_LABEL = "Case";
const DOMAIN_LABELS = {"common_occupational_skills": "Common Occupational Skills", "process_measuring_and_indicating_devices": "Process Measuring and Indicating Devices", "safety_and_security_systems": "Safety and Security Systems", "hydraulic_pneumatic_and_electrical_systems": "Hydraulic Pneumatic and Electrical Systems", "final_control_elements": "Final Control Elements", "communication_systems": "Communication Systems", "control_systems_and_process_control": "Control Systems and Process Control"};  // maps domain key -> human-readable label for display
